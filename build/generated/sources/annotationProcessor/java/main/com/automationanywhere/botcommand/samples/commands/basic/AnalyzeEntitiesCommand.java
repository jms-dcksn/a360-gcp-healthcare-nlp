...
public final class AnalyzeEntitiesCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(AnalyzeEntitiesCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    AnalyzeEntities command = new AnalyzeEntities();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.execute((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("text")));
